...
const CORRECTED_TABLE = {
  ...
  '4,8': { tier: 4, p_eq: 47.31, mn: '631', mp: 48 },
  // 3星（p_eq 45–47.1）
  '1,4': { tier: 3, p_eq: 47.08, mn: '234', mp: 47 },
  ...
  // 2星（p_eq 43–45）
  '6,9': { tier: 2, p_eq: 44.83, mn: '4311', mp: 44 },
  ...
  '5,5': { tier: 1, p_eq: 30.76, mn: '156', mp: 36 },
};
